...
public class ExampleScenario extends JUnitStory {
    @Override
    ...
    public List<CandidateSteps> candidateSteps() {
        return new InstanceStepsFactory(configuration(), new ExampleScenarioSteps(), new ExampleScenarioSteps()).createCandidateSteps();
    }
}

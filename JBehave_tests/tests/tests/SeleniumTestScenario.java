...
public class SeleniumTestScenario extends JUnitStory {
    @Override
    ...
    public List<CandidateSteps> candidateSteps() {
        return new InstanceStepsFactory(configuration(), new SeleniumTestScenarioSteps(), new SeleniumTestScenarioSteps()).createCandidateSteps();
    }
}
